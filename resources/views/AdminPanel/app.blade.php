...
-->
<html lang="{{ App::getLocale() }}" {{ App::getLocale()=='ar' ? 'direction="rtl" dir="rtl" style="direction: rtl"' : ' '
    }}>
<!--begin::Head-->
...
<head>
    ...
    @if (App::getLocale() == 'ar')
    <link href="{{ asset('assets/css/ar-style.bundle.css') }}" rel="stylesheet" type="text/css" />
    @else
