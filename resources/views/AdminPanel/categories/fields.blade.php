                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                <input type="text" name="{{ $name }}[title]"
                                    ...
                                    value="{{ old($name . '.title', isset($category) ? $category->getTranslation($name)->title : '') }}"
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                ...
                                {{ old($name . '.description', isset($category) ? $category->getTranslation($name)->description : '') }}
                            </textarea>
        ...
        <div class="fv-row mb-10 fv-plugins-icon-container">
            ...
            <div class="image-input image-input-empty image-input-outline image-input-placeholder"
                ...
                <div class="image-input-wrapper w-125px h-125px"
                    ...
                    style='background-image:url({{ $category->image }})'@endisset>
                </div>
