...
<body style="
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <!-- LOGO -->
        <tr>
            <td bgcolor="#bd2c3d" align="center">
        ...
        <tr>
            <td bgcolor="#bd2c3d" align="center" style="padding: 0px 10px 0px 10px">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                    <tr>
                ...
                ">
                            ...
                            <img src="{{\App\Models\Setting::first()->logo}}"
                                width="125" height="120" style="display: block; border: 0px; border-radius: 8px" />
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px">
                ...
                ">
                            ...
                            <p style="margin-top: 20px">Your Email Verification Code  is: {{$code}} </p>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff" align="left" style="
                  ...
                  line-height: 25px;
                ">
                            <p style="margin: 0">Thank You,<br />{{\App\Models\Setting::first()->app_name}} Team</p>
                        </td>
                    </tr>
                </table>
            </td>
